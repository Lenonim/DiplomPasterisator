...
% Рисует рамку
    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,286)(5,0)
                    \linethickness{0.5mm}
                    \put(-1, 0){\framebox(185,285){}}
                    \put(-1, 0){\Box{7}{\gostRamkaFont Изм.}}
                    \put(-1, 15){\line(1,0){185}}
                    \put(-1, 5){\line(1,0){65}}
                    \linethickness{0.25mm}
                    \put(-1, 10){\line(1,0){65}}
                    \linethickness{0.5mm}
                    \put(6, 0){\VL}
                    \put(6, 0){\Box{10}{\gostRamkaFont Лист.}}
                    \put(16, 0){\VL}
                    \put(16, -0.25){\Box{15}{\gostRamkaFont № докум.}}
                    \put(39, 0){\VL}
                    \put(39, -0.25){\Box{10}{\gostRamkaFont Подп.}}
                    \put(54, 0){\VL}
                    \put(54, -0.25){\Box{10}{\gostRamkaFont Дата}}
                    \put(64, 0){\VL}
                    \put(64, 0){\makebox(110,15){\cyrillicfont \englishfont \fontsize{18pt}{0pt}\selectfont ДП.АС59.200043 - 05 81 00}}
                    \put(174, 0){\makebox(10,25){\gostRamkaFont Лист}}
