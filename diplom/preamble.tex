...
% Рисует рамку
    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,287)(5.5,0.7)
                    \linethickness{0.5mm}
                    ...
                    \put(7, 0){\line(0,1){15}}
                    \put(7, 0){\Box{10}{\itshape \cyrillicfontsf \fontsize{8pt}{0pt}\selectfont Лист.}}
                    \put(17, -0.25){\line(0,1){15}}
                    \put(17, -0.25){\Box{15}{\itshape \cyrillicfontsf \fontsize{8pt}{0pt}\selectfont № докум.}}
                    \put(40, 0){\line(0,1){15}}
                    \put(40, 0){\Box{10}{\itshape \cyrillicfontsf \fontsize{8pt}{0pt}\selectfont Подп.}}
                    \put(55, -0.25){\line(0,1){15}}
                    \put(55, -0.25){\Box{10}{\itshape \cyrillicfontsf \fontsize{8pt}{0pt}\selectfont Дата}}
                    \put(65, 0){\line(0,1){15}}
                    \put(65, 0){\makebox(109,15){\cyrillicfont \englishfont \fontsize{18pt}{0pt}\selectfont ДП.АС59.200043-05 81 00}}
                    \put(175, 0){\makebox(10,25){\cyrillicfont \itshape \fontsize{8pt}{0pt}\selectfont Лист}}
                    \put(175, 0){\line(0,1){15}}
                    \put(175, 0){\makebox(10,10){\cyrillicfont \englishfont \fontsize{12pt}{0pt}\selectfont \thepage}}
