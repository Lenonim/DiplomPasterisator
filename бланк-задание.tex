\documentclass[12pt, А4]{article} % задаём тип документа: статья - и его характеристики: 12-ый стандартный шрифт, размер листа А4
    ...
    \usepackage{fontspec} % подключаем модуль для работы с 
    ...
    \setsansfont[Ligatures=TeX]{Nimbus Sans L} % устонавливаем дополнительный шрмфт 

    \newfontfamily\cyrillicfont[Script=Cyrillic]{Times New Roman} % делаем так, чтобы русский язык мог отображаться главным шрифтом 
    \newfontfamily\cyrillicfontsf[Script=Cyrillic]{Nimbus Sans L} % делаем так, чтобы русский язык мог отображаться дополнительным шрифтом 

    \newfontfamily\englishfont{Times New Roman} % делаем так, чтобы английский язык мог отображаться главным шрифтом 
    \newfontfamily\englishfontsf{Nimbus Sans L} % делаем так, чтобы английский язык мог отображаться дополнительным шрифтом 
