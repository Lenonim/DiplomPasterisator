    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(184, 286)(5, 0)
                    ...
                    \put(65, 0){\makebox(70,35){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape Прогнозирование данных }}
                    \put(65, 0){\makebox(70,25){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape временных рядов технологического процесса}}
                    \put(65, 0){\makebox(70,15){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape пастеризационной уставноки}}
